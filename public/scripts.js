...
const response = await fetch('http://localhost:3000/api/proxy/boletos', {
method: 'POST',
headers: {
'Content-Type': 'application/json',
},
...
const response = await fetch('http://localhost:3000/api/proxy/oss', {
method: 'POST',
headers: {
'Content-Type': 'application/json',
},
...
async function criarOss() {
  try {
    ...
    document.getElementById('ossForm').addEventListener('submit', async function(event) {
      ...
      try {
        const response = await fetch('http://localhost:3000/api/proxy/criar-oss', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
...
const usuariosResponse = await fetch('http://localhost:3000/api/proxy/usuarios', {
method: 'POST',
headers: {
'Content-Type': 'application/json',
},
...
const response = await fetch('http://localhost:3000/api/proxy/reiniciar-conexao', {
method: 'POST',
headers: {
'Content-Type': 'application/json',
},
...
const response = await fetch('http://localhost:3000/api/proxy/desbloqueio-confianca', {
method: 'POST',
headers: {
'Content-Type': 'application/json',
},
...
const response = await fetch('http://localhost:3000/api/proxy/informar-pagamento', {
method: 'POST',
headers: {
'Content-Type': 'application/json',
},
